...
const PRODUCTS = [
    ...
    { id: 17, name: "Plum & Blush Herringbone",   category: "Two-tone", price: 18, currency, material: "Woven Cord & Toggle Clasp",      description: "Chunky herringbone-weave bracelet blending deep plum brown and soft blush pink cord, with silver toggle clasp. Rich texture and a beautiful two-tone contrast.", color: "#F5E0E8", tag: "Artisan Pick", image: "images/IMG_9290.webp" },
    { id: 18, name: "Violet Chunky Braid",        category: "Chunky",   price: 18, currency, material: "Braided Cord & Lobster Clasp",   description: "Deep violet chunky flat-braided cord bracelet with polished silver end caps and a lobster clasp with extender chain. Vibrant, bold and richly coloured.", color: "#D8D0F0", tag: "Bestseller",   image: "images/IMG_9287.webp" },
];
